...
function AnnouncementsList(props) {
  ...
  return (
    <div
      className={`shadow-lg rounded-xl w-full md:w-4/5 p-4 bg-white dark:bg-gray-800 relative overflow-hidden ${headerClass} `}
    >
      ...
      <div class="flex items-start mb-6 rounded justify-between">
        ...
        <div class="flex items-center w-full justify-between">
          <div class="flex text-sm flex-col w-full ml-2 items-start justify-between">
            <p class="text-gray-700 dark:text-white">
              <span class="font-bold mr-1">Karen</span>
      ...
      <div class="flex items-start mb-6 rounded justify-between">
        ...
        <div class="flex items-center w-full justify-between">
          <div class="flex text-sm flex-col w-full ml-2 items-start justify-between">
            ...
            <p class="text-gray-300">Aug 09</p>
          </div>
        </div>
      </div>
      <div class="flex items-start rounded justify-between">
        ...
        <div class="flex items-center w-full justify-between">
          <div class="flex text-sm flex-col w-full ml-2 items-start justify-between">
            <p class="text-gray-700 dark:text-white">
              <span class="font-bold mr-1">John</span>
              uploaded 17 pictures on concept deisgn galery page
            </p>
            <p class="text-gray-300">Aug 1</p>
          </div>
        </div>
      </div>
    </div>
